# Impressum – Arbeitsfassung, nicht live

Für die bereits öffentlich erreichbare FormularFuchs-Website ist im Entwicklungszweig die Datei [impressum/index.html](../impressum/index.html) mit den vom Betreiber ausdrücklich freigegebenen Angaben vorbereitet:

**Betreiber:** Felix Ducksch (Projektname: FormularFuchs)
...
**E-Mail:** FormularFuchs@genial.ms  
**Website:** https://formularfuchs.github.io/
...
**Anbieterklärung zur postalischen Zustellung (zusätzlich geprüft):** Anschrift.net schreibt in FAQ, Produktbeschreibung und Kontaktübersicht **ausdrücklich**, dass behördliche und gerichtliche Schreiben, Einschreiben und förmliche Zustellungen nach ZPO an die freigegebene c/o-Anschrift angenommen werden. Laut Anbieter erhält der Kunde nicht nur eine reine Weiterleitungsadresse, sondern auch einen physischen Workspace-Bezug mit Nutzungsmöglichkeit; Dienstleistungsvertrag/Empfangsbevollmächtigung werden im Bestellprozess vereinbart. Der Anbieter sagt zugleich, es sei **keine Wohnadresse, Betriebsstätte oder Niederlassung**. Das steht nicht im Widerspruch zu § 5 DDG, ohne deshalb die individuelle rechtliche Beurteilung vorwegzunehmen. LFK warnt vor *reinen* virtuellen Postweiterleitern, nicht pauschal vor diesem nach eigener Darstellung anderen Modell. Die positive Aussage stammt vom Anbieter, ist keine unabhängig geprüfte gerichtliche Entscheidung zur konkreten Buchung.

Belege: https://anschrift.net/faq/ (Fragen „Sind förmliche und gerichtliche Zustellungen nach ZPO möglich?“, „Kann ich nur als Unternehmen oder auch als Privatperson bestellen?“, „Darf ich unter der Anschrift einen Firmensitz anmelden?“) · https://anschrift.net/dein-impressum/ · https://anschrift.net/kontakt/ · https://www.lfk.de/service/dokumente-rechtsgrundlagen/leitfaden-zur-impressumspflicht-im-internet

**Noch vor Übernahme nach main prüfen:**
1. **Anbieter hat Gerichtspost/behördliche Zustellungen und Workspace-Nutzungsbezug in FAQ ausdrücklich bestätigt**. Im eigenen Kundenkonto kontrollieren, ob freigegebener Standort/Adressformat und Vertragsunterlagen für die konkrete Buchung stimmen. Kein unnötiges zweites Nachfragen zur allgemeinen Gerichtspostbehauptung. Individuelle rechtliche Unsicherheit bleibt bestehen; bei Zweifel zur Anwendung des Dienstes auf das konkrete Impressum fachliche Prüfung. Dienstende sofort berücksichtigen.
